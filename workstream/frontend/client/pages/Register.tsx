  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Welcome ${registrationData.firstName}! You can now log in to continue.`,
      });

      // Redirect to login with success message
      navigate("/login", {
        state: {
          message: `Registration complete for ${registrationData.email}! Please log in to continue.`,
